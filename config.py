...
OWNER_ID = int(getenv("OWNER_ID", 7561224284))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/sqenaah/Armed-Music-Bot.git",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/armedgame")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/armedgame")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://i.ibb.co/xq2yZJkB/image.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://i.ibb.co/FLbCd2sL/image.jpg"
)
